document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("OriginalSort").addEventListener("click", (event) => {
    ...
    if (
      !element.dataset.sort_type ||
      element.dataset.sort_type === "descending"
    )
      element.dataset.sort_type = "ascending";
    ...
    //adding in table
    if ((element.dataset.sort_type = "descending"))
      var table_rows_new = table_rows.reverse();
